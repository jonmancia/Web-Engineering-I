...
function getMileageInfo() {
    ...
    let url = "http://157.201.194.254/cgi-bin/cs213/mileageAjaxJSON?" + inputElements[0].name + "=" + inputValues[0] + "&" + inputElements[1].name + "=" + inputValues[1] + "&" + inputElements[2].name + "=" + inputValues[2] + "&" + inputElements[3].name + "=" + inputValues[3];
